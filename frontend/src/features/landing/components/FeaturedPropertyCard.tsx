...
function FeaturedPropertyCard({ property }: FeaturedPropertyCardProps) {
  ...
  return (
    <article className="overflow-hidden rounded-2xl border bg-white shadow-sm" style={{ borderColor: "#E7E1FA" }}>
      <div className="relative h-44 w-full overflow-hidden" style={{ backgroundColor: "#F2EEFD" }}>
        {primaryImage ? (
          <img
          ...
          <div className="flex h-full items-center justify-center text-sm" style={{ color: palette.softPurple }}>
            No image
          </div>
        )}
        <button
      ...
      <div className="p-4">
        <h3 className="line-clamp-1 text-base font-bold" style={{ color: palette.deep }}>
          {property.title}
        </h3>

        <p className="mt-1 flex items-center gap-1 text-sm" style={{ color: palette.purple }}>
          <MapPin size={14} />
          {property.city}
        </p>

        <div className="mt-3 flex items-end justify-between">
          <p className="text-2xl font-extrabold" style={{ color: palette.purple }}>
